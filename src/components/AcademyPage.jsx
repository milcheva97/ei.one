...
function AcademyPage() {
  useEffect(() => {
    ...
    const description = 'The EI.one Academy turns learning into real experience — practical courses, mentorship and hands-on projects that become verified experience inside your Experience Identity.'
  ...
  return (
    <>
      <Header loginHref="/login" languagePage="academy.php" />

      <main className="info-page">
        <section className="academy-hero">
          <div className="wrap academy-hero-grid">
            <div className="academy-hero-copy">
              <p className="academy-kicker">Learn &amp; Grow</p>
              <h1>The Academy that turns learning into real experience.</h1>
              <p>Practical courses, mentorship and hands-on projects — every skill you build becomes a verified experience inside your <strong>Experience Identity</strong>.</p>
            ...
            <div className="academy-hero-visual" aria-label="What the Academy gives you">
              <div className="academy-hero-panel">
                <span className="academy-panel-row">
                  <i className="fa-solid fa-laptop-code" aria-hidden="true"></i>
                  <span><strong>Practical courses</strong><small>Real challenges from ecosystem companies.</small></span>
                </span>
                <span className="academy-panel-row">
                  <i className="fa-solid fa-certificate" aria-hidden="true"></i>
                  <span><strong>Verified skills</strong><small>Attested experience in your Identity.</small></span>
                </span>
                <span className="academy-panel-row">
                  <i className="fa-solid fa-people-arrows" aria-hidden="true"></i>
                  <span><strong>Mentorship</strong><small>Guidance from ecosystem professionals.</small></span>
                </span>
                <span className="academy-panel-row">
                  <i className="fa-solid fa-bridge" aria-hidden="true"></i>
                  <span><strong>Bridge to work</strong><small>Connect directly to companies.</small></span>
                </span>
              </div>
              <div className="academy-hero-steps">
                <div><span>01</span><strong>Learn</strong></div>
                <div><span>02</span><strong>Verify</strong></div>
                <div><span>03</span><strong>Get matched</strong></div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="wrap">
            ...
            <div className="info-steps">
              <div className="info-step">
                ...
                <div>
                  <h4>Choose a path</h4>
                  <p>Pick a course or program aligned with where you want to grow.</p>
                </div>
              </div>
              <div className="info-step">
                ...
                <div>
                  <h4>Learn &amp; build</h4>
                  <p>Work on hands-on projects with mentors and real feedback.</p>
                </div>
              </div>
              <div className="info-step">
                ...
                <div>
                  <h4>Get verified</h4>
                  <p>Your results become a verified experience in your Identity.</p>
                </div>
              </div>
              <div className="info-step">
                ...
                <div>
                  <h4>Get matched</h4>
                  <p>Verified skills connect you to companies and opportunities.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="wrap">
            <div className="info-cta">
              ...
              <div className="actions">
                ...
                <a className="button secondary" href="/contact" style={{ color: '#ffffff', borderColor: 'rgba(255, 255, 255, 0.4)' }}>Talk to us</a>
              </div>
            </div>
          </div>
        </section>
