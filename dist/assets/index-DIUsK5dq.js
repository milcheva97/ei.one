...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function Vv(){return new ia({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_h(),fragmentShader:`
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function kv(){return new ia({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_h(),fragmentShader:`
